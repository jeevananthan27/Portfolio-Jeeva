...
export default function Skills() {
  ...
  return (
    <section id="skills" className="bg-transparent backdrop-blur-md text-white py-24 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-20">
          ...
          <p className="mt-6 text-gray-400 max-w-2xl mx-auto font-mono text-sm tracking-widest uppercase">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
          {skills.map((skill, index) => {
            ...
            const neonColors = {
              ...
              'text-gray-800 dark:text-white': 'shadow-white/20 border-white/30 text-white'
            };
            ...
            return (
              <div 
                key={index} 
                className={`relative group bg-black/40 backdrop-blur-sm border-2 ${neonStyle} rounded-xl p-8 flex flex-col items-center justify-center transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_0_30px_rgba(var(--neon-rgb),0.4)] overflow-hidden`}
              >
                ...
                <h3 className="mt-4 text-sm font-bold text-gray-300 tracking-[0.2em] uppercase text-center relative z-10 group-hover:text-white transition-colors">
                  {skill.name}
                </h3>
